...
SOURCEFILES_QUOTED_IF_SPACED=Initialize.c main.c TinierScreen.c PozyxPIC_I2C.c GraphicsBuffer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Initialize.o ${OBJECTDIR}/main.o ${OBJECTDIR}/TinierScreen.o ${OBJECTDIR}/PozyxPIC_I2C.o ${OBJECTDIR}/GraphicsBuffer.o
POSSIBLE_DEPFILES=${OBJECTDIR}/Initialize.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/TinierScreen.o.d ${OBJECTDIR}/PozyxPIC_I2C.o.d ${OBJECTDIR}/GraphicsBuffer.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Initialize.o ${OBJECTDIR}/main.o ${OBJECTDIR}/TinierScreen.o ${OBJECTDIR}/PozyxPIC_I2C.o ${OBJECTDIR}/GraphicsBuffer.o

# Source Files
SOURCEFILES=Initialize.c main.c TinierScreen.c PozyxPIC_I2C.c GraphicsBuffer.c
...
${OBJECTDIR}/TinierScreen.o: TinierScreen.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TinierScreen.o.d 
	@${RM} ${OBJECTDIR}/TinierScreen.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  TinierScreen.c  -o ${OBJECTDIR}/TinierScreen.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/TinierScreen.o.d"      -g -D__DEBUG   -mno-eds-warn  -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/TinierScreen.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/GraphicsBuffer.o: GraphicsBuffer.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/GraphicsBuffer.o.d 
	@${RM} ${OBJECTDIR}/GraphicsBuffer.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  GraphicsBuffer.c  -o ${OBJECTDIR}/GraphicsBuffer.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/GraphicsBuffer.o.d"      -g -D__DEBUG   -mno-eds-warn  -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/GraphicsBuffer.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/TinierScreen.o: TinierScreen.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/TinierScreen.o.d 
	@${RM} ${OBJECTDIR}/TinierScreen.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  TinierScreen.c  -o ${OBJECTDIR}/TinierScreen.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/TinierScreen.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/TinierScreen.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/GraphicsBuffer.o: GraphicsBuffer.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/GraphicsBuffer.o.d 
	@${RM} ${OBJECTDIR}/GraphicsBuffer.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  GraphicsBuffer.c  -o ${OBJECTDIR}/GraphicsBuffer.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/GraphicsBuffer.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/GraphicsBuffer.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
